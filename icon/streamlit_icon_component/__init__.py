...
def streamlit_icon(icon_name, icon_type="icon", disabled=False, icon_size="medium"):
...
streamlit_pagination
    ...
    component_value = _component_func(icon_name=icon_name, icon_type=icon_type, disabled=disabled, icon_size=icon_size)
